                ...
                case MSG_READ_ATTRIBUTION_SOURCE:
                    ...
                    try {
                        ...
                        if (receivingMessage.what == MSG_READ_ATTRIBUTION_SOURCE_BUNDLE) {
                            ...
                            attributionSource = receivingBundle.getParcelable(
                                    AttributionSourceTest.ATTRIBUTION_SOURCE_KEY);
                        } else {
                            attributionSource = (AttributionSource) receivingMessage.obj;
                        }

                        if (attributionSource.getUid() == -1) {
                            replyBundle.putByte(KEY_READ_RESULT, (byte) 0);
                            Log.i(TAG, "Failed to read AttributionSource: credentials missing");
                        } else {
