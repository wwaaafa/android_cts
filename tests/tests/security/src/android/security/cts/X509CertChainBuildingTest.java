...
public class X509CertChainBuildingTest extends AndroidTestCase {
     ...
     * All certificates use ECDSA keys and SHA-256 digests unless otherwise specified.
     ...
     *  [leaf2]
     *
     *  These can be generated by running path_building_certs.go in the top level
     *  directory for the CtsSecurityTestCases test suite.
     */
