...
package com.android.cts.sdksidetests.webviewsandboxzoomtest;
...
import android.webkit.cts.WebViewZoomTest;

public class WebViewSandboxZoomTestSdk extends SdkSandboxTestScenarioRunner {
    private WebViewZoomTest mTestInstance = new WebViewZoomTest();
