...
import com.android.interactive.steps.enterprise.settings.NavigateToPersonalInternetOrWifiSettingsStep;
...
public final class WifiTest {
    ...
    public void disallowConfigWifiIsNotSet_canConfigWifi() throws Exception {
        Step.execute(NavigateToPersonalInternetOrWifiSettingsStep.class);
