...
public class CVE_2023_40112 extends NonRootSecurityTestCase {

    // b/168903843
    // Vulnerability Behaviour: SIGSEGV in self
    // Vulnerable Library: libcups (As per AOSP code)
    // Vulnerable Function: _cupsStrAlloc() (As per AOSP code)
    @AsbSecurityTest(cveBugId = 168903843)
    @Test
    public void testPocCVE_2023_40112() {
        try {
            final String library = "libcups";
            final String binaryName = "CVE-2023-40112";
            ...
            TombstoneUtils.Config crashConfig =
                    new TombstoneUtils.Config()
                            ...
                            .setBacktraceIncludes(
                                    new BacktraceFilterPattern(library, "_cupsStrAlloc"))
                            .setSignals(signals);

            NativePoc.builder()
                    .resources("cve_2023_40112")
                    .pocName(binaryName)
